...
{
	public class AnimationSystemPseudoTransformCreator : EditorWindow
	{
		[MenuItem("LibFPS/AnimationSystem/Animation System Transform Creator")]
		public static void ShowWindow()
		{
			EditorWindow.GetWindow(typeof(AnimationSystemPseudoTransformCreator));
		}
		...
		public void OnGUI()
		{
			GUILayout.Label("<color=#2288EE>Animation System</color>", new GUIStyle() { fontSize = 36 , richText = true });
			GUILayout.Label("<color=#2288EE>Pseudo Transform Creator</color>" , new GUIStyle() { fontSize = 24 , richText = true });
